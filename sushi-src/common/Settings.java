...
public final class Settings {
	...
	public static final Path Z3_PATH               = Paths.get("/opt", "homebrew", "bin", "z3");
	public static final Path JAVA8_HOME            = Paths.get("/Library", "Java", "JavaVirtualMachines", "zulu-8.jdk", "Contents", "Home");
	...
	public static final Path SUSHI_LIB_PATH = SUSHI_WORKSPACE.resolve(Paths.get("libs", "sushi-lib-0.3.0-SNAPSHOT.jar"));
